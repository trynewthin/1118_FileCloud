  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-40 md:hidden pointer-events-none pb-[env(safe-area-inset-bottom,0px)]">
      <div className="pointer-events-auto mx-auto mb-5 px-4">
        <GlassCard
          variant="strong"
          className={cn("flex h-16 items-center justify-around px-4 overflow-visible")}
        >
              ...
              >
                <div
                  className={cn(
                    ...
                    isActive
                      ? "h-13 w-13 -translate-y-[72%] bg-primary text-primary-foreground shadow-[0_0_14px_hsl(var(--primary)/0.35)]"
